...
function knapsack(capacity, weight, profit, n) {
    ...
    if(weight[n-1] > capacity) {
        ...
        return Math.max(profit[n-1]+ knapsack(capacity - weight[n-1], weight, profit, n-1), knapsack(capacity, weight, profit, n-1));
    }
}
